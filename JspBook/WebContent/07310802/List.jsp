...
<body>
	...
	<%
	 ...
	 %>
		...
		<table border=1>
			<tr>
				<td class='htitle' width=80 align='center'>번호</td>
				<td class='htitle' width=300 align='center'>제목</td>
				<td class='htitle' width=100 align='center'>작성자</td>
				<td class='htitle' width=80 align='center'>조회수</td>
				<td class='htitle' width=150 align='center'>작성일</td>
				<td class='htitle' width=80 align='center'>삭제</td>
			</tr>
	 <%
		//next()값이 참, 거짓을 반환
		while (rs.next()) {
