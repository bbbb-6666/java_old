...
//128은 안들어감. 0~127까지 가능하기 때문에.
		...
		*/
		...
		/* 정수형과 실수형을 섞어서 계산하면 실수형이 된다. 바이트타입과 인티젼타입으로 바뀐다. 조금더 큰쪽으로 자동으로 바뀐다.
		       형 변환이 자동적으로 되는 것을 묵시적 형변환implicit 라고 함.
		...
		*/
		...
		System.out.println((int)ch3);  // = 44032 : 유니코드값을 숫자값으로 표현을 한 것
		*/
		
		/* www.unicode.org > 유니코드스탠다드 > 코드 차트 > (오른쪽쯤에) Hangul Jamo 
		 *  > 한글 밑에 써져있는게 유니코드 값 
		 */
		
		//유니코드값을 이용해서 한글 출력쓰 , 캐릭터타입은 유니코드도 저장할 수 있다.
		char ch3='\uac00';           //1100 : 유니코드 넣으면 유니코드값이 출력이 됨. 
		System.out.println(ch3);
